...
<div class="fw-bold fs-20 pb-4 pt-5"><?php echo e(__("Post Stats")); ?></div>
        ...
        <div class="card shadow-sm rounded-4 hp-100 min-h-140 bg-pink-100 border border-pink-200">
            <div class="card-body d-flex flex-column justify-content-center align-items-start p-4">
                <div class="d-flex align-items-center mb-2 gap-12">
                    ...
                    <span class="fw-6 fs-14 text-muted"><?php echo e(__('Total')); ?></span>
                </div>
                <div class="fw-bold fs-2 mb-1 text-dark"><?php echo e(number_format($totalPosts)); ?></div>
                <div class="fs-14 text-muted">
                    <?php echo e($totalGrowth == 0 ? '0%' : ($totalGrowth > 0 ? '+' : '-') . abs($totalGrowth) . '%'); ?>
...
<div class="row mt-4">
    ...
    <div class="col-md-12 mb-4">
        <div class="card border-0 shadow-sm">
            <div class="card-header">
                <h5 class="fw-5 fs-16"><?php echo e(__('Successful vs Failed Posts Over Time')); ?></h5>
            </div>
            ...
            <div class="d-flex card-body p-0">
                ...
                <div class="flex-fill px-4 py-3 border-end">
                    <div class="text-gray-500 fs-14 mb-2"><?php echo e(__('Failed')); ?></div>
    ...
    <div class="col-md-6 mb-4">
        <div class="card border-0 shadow-sm">
            <div class="card-header">
                <div class="fw-5">
                    <?php echo e(__('Posts by Social Network')); ?>
...
<script>
    ...
    Main.Chart('areaspline', errorSuccessChart.series, 'posts-error-success-chart', {
        title: '<?php echo e(__('Daily AI Credit Usage')); ?>',
        legend: {
            enabled: false
        },
        xAxis: {
    ...
    // Chart: Posts by Team
    Main.Chart('column', <?php echo json_encode($postsByTeamChart['series']); ?>, 'posts-by-team-chart', {
        title: '<?php echo e(__("Posts by Team")); ?>',
        xAxis: { categories: <?php echo json_encode($postsByTeamChart['categories']); ?> }
    });

    // Chart: Posts by Social Network
    Main.Chart('pie', <?php echo json_encode($postsBySocialChart['series'][0]['data']); ?>, 'posts-by-social-chart', {
        title: '<?php echo e(__("Posts by Social Network")); ?>'
    });

    // Chart: Posts by Status
    Main.Chart('column', <?php echo json_encode($postsByStatusChart['series']); ?>, 'posts-by-status-chart', {
        title: '<?php echo e(__("Posts by Status")); ?>',
        xAxis: { categories: <?php echo json_encode($postsByStatusChart['categories']); ?> }
    });
</script><?php /**PATH /home/u774605506/domains/mdar.cc/public_html/modules/AppPublishing/resources/views/partials/admin-dashboard-item.blade.php ENDPATH**/ ?>