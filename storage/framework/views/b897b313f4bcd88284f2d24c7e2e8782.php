<div class="hide-on-mobile flex flex-col justify-center flex-1 px-8 py-16 bg-white z-10">
    <img class="absolute left-0 z-20 bottom-0 pointer-events-none hide-on-mobile" src="<?php echo e(theme_public_asset('images/sign-up/gradient.svg')); ?>" alt="" />
    <div class="max-w-lg mx-auto">
        <a class="mb-28 inline-block" href="<?php echo e(url('')); ?>">
        ...
        <h3 class="mb-9 text-xl font-bold font-heading leading-normal">
            <?php echo e(__("Why join our community?")); ?>
        ...
        <ul class="md:max-w-xs">
            <li class="mb-5 flex flex-wrap">
                ...
                <span class="flex-1 font-medium leading-relaxed">
                    <?php echo e(__("Unlock powerful features and get more done in less time")); ?>
            ...
            <li class="mb-5 flex flex-wrap">
                ...
                <span class="flex-1 font-medium leading-relaxed">
                    <?php echo e(__("Enjoy 24/7 support from our dedicated expert team")); ?>
            ...
            <li class="mb-5 flex flex-wrap">
                ...
                <span class="flex-1 font-medium leading-relaxed">
                    <?php echo e(__("Secure and reliable – your data is always protected")); ?>

                </span>
            </li>
        </ul>
    </div>
</div><?php /**PATH /home/u774605506/domains/mdar.cc/public_html/resources/themes/guest/nova/resources/views/partials/login-screen.blade.php ENDPATH**/ ?>