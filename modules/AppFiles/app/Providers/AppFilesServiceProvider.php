...
class AppFilesServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'AppFiles';

    protected string $nameLower = 'appfiles';
    ...
    public function boot(): void
    {
        ...
        if (! class_exists('UploadFile')) {
            class_alias(\Modules\AppFiles\Facades\UploadFile::class, 'UploadFile');
        }
