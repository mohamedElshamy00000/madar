...
namespace Modules\AppTeamJoined\Providers;
...
use Modules\AppTeamJoined\Http\Middleware\CaptureJoinTeam;

class AppTeamJoinedServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'AppTeamJoined';

    protected string $nameLower = 'appteamjoined';
