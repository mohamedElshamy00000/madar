...
<head>
    ...
    {{-- 
        This is the standard and correct way to load Vite assets in Laravel 11.
        It automatically handles loading the correct CSS and JS files.
        هذه هي الطريقة القياسية والصحيحة لتحميل ملفات Vite في Laravel 11.
    ...
    {{-- 
        ...
        السطر أدناه قد يكون من حزمة قديمة ولم نعد بحاجة إليه.
        الـ @vite directive أعلاه هو البديل الحديث.
    --}}
    {{-- {!! Script::globals() !!} --}}
...
<body class="antialiased bg-body text-body font-body">
    ...
    <div class="fixed bottom-0 z-50 w-full cookie-policy-bar" style="display: none;">
        <div class="p-10 md:px-20 lg:px-36 bg-white border border-coolGray-100 shadow-md">
            <div class="container mx-auto">
                <div class="flex flex-wrap items-center -mx-4">
                    <div class="w-full md:w-1/2 px-4 mb-8 md:mb-0">
    ...
    {{-- 
        I removed the old <script> tags for jquery.min.js and main.js
        because the @vite directive should handle loading your main JS file,
        which should in turn include jQuery if needed.
        This prevents loading scripts twice.
        
        لقد قمت بإزالة وسوم <script> القديمة لـ jquery.min.js و main.js
        لأن الـ @vite directive يجب أن يتعامل مع تحميل ملف JS الرئيسي،
        والذي بدوره يجب أن يتضمن jQuery إذا لزم الأمر.
        هذا يمنع تحميل الـ scripts مرتين.
    --}}
</body>
</html>
